    ...
    <div class="form-group m-0">
        <span class="control-span">
            <div class="input-group-btn right-btn">
                <input type="text" id="search_key" class="form-control" maxlength="10" autocomplete="off">
    ...
    <div id="list-search">
        ...
        <div class="list-search-content d-flex flex-column align-items-center justify-content-center">
            @foreach ($left_view_data[0] as $item)
                <div class="list-item w-100 d-flex align-items-center" employee_typ="{{$item['employee_typ']}}">
                    <span class="pl-3 w-100 h-100 d-flex align-items-center">{{$item['employee_typ_nm']}}</span>
                </div>
            @endforeach
        </div>
    </div>
